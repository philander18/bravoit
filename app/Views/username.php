        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-md-8 col-lg-6 col-xl-4 col-12">
                    <div class="card">
                        <div class="card-body p-4 shadow-sm" style="border-radius: 4px;">
                            <form id="formUsername" class="">

                                <div class="row mb-2">
                                    <div class="col-12">
                                        <input type="text" id="no_ktp" name="username" class="form-control" placeholder="Isi Nama Medion" maxlength="150" />
                                        <small style="display:none" class="text-danger" id="error-username">Nama tidak ditemukan</small>
                                    </div>
                                </div>
